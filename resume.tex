...
%\#1682, 64TH ST, 2ND FL &  zzhou03@students.poly.edu \& conanchou1412@gmail.com \\
\#1682, 64TH ST, 2ND FL & conanchou1412@gmail.com \\
%Brooklyn, NY, 11204 & http://conanblog.me \& http://conanchou.github.io\\
...
%	\begin{itemize}
%		\resitem{Description: Collect and analys user's interests for personalized news recommendation}
%		\resitem{Technology: PHP, Python, C, node.js, MongoDB, MySQL, WordPress, AWS, ElasticSearch}
%	\end{itemize}
...
\begin{itemize}
\item
	\ressubheading{Leap Motion System Interface}{Leap Motion}{NYC APIDay Hackathon, 2nd Place}{2013}
	\begin{itemize}
		\resitem{Description: A translator that convert 3-D gestures to GUI operations.}
		\resitem{Technology: Java, Leap Motion API}
	\end{itemize}
%\item
%	\ressubheading{Infophile}{iOS}{in progress, not released yet}{2013}
%	\begin{itemize}
...
\item
	...
	\begin{itemize}
		...
		\resitem{Technology: Sphinx, Markdown}
...
\item
	...
	\begin{itemize}
		\resitem{Description: A plugin for TweetNest to forward tweets to other SNS like renren, sina, fanfou, etc.}
		\resitem{Technology: PHP, MySQL, Twitter API}
